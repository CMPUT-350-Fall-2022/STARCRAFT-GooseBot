# GooseBot
Implementation of Zerg AI starcraft bot using the BasicSc2Bot Template SC2 Bot for CMPUT 350 at UAlberta.
...
```
./GooseBot.exe -c -a zerg -d Hard -m CactusValleyLE.SC2Map
```
